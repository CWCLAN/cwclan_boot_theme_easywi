...
function processForm(vars) {
	...
	vars = vars + "&windowWidth=" + document.getElementById("ajaxContentWindow").offsetWidth;
	vars = vars + "&windowHeight=" + document.getElementById("ajaxContentWindow").offsetHeight;
...
var globalEditorDefaultSize = 500;
